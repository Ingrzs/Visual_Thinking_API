class StudentServices{
    ...
    static filtercertificationtrue (students,certificado){
        ...
        return studentswithcertication
    }
    
    static filtercertificationfalse (students,certificado){
        const studentnotcertication = students.filter((student) => student.haveCertification == certificado);
        return studentnotcertication
    }
